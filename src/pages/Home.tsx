...
import { ArrowRight, Star, Heart, ShieldCheck, Sparkles, MessageCircle, Instagram } from "lucide-react";
...
export default function Home() {
  ...
  useEffect(() => {
    fetch("/api/products")
      .then((res) => res.json())
      .then((data: Product[]) => {
        setFeaturedProducts(data.filter((p) => p.featured === 1).slice(0, 6));
      });
  }, []);
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO 
        title="Home" 
        description="Explore handmade candles, festive decor, and pooja decorations designed with love." 
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden bg-stone-900">
        <div className="absolute inset-0 z-0">
          <img
            src="https://picsum.photos/seed/decor/1920/1080"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-white mb-6 leading-tight">
              Handcrafted Decor That Brings Beauty To Every Celebration
            </h1>
            <p className="text-lg md:text-xl text-stone-300 mb-10 font-light max-w-2xl mx-auto">
              Explore handmade candles, festive decor, and pooja decorations designed with love.
            </p>
      ...
      <section className="py-24 bg-white overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif text-stone-900 mb-4">Decor Inspiration</h2>
            <p className="text-stone-500">Follow us on Instagram @radhekrishnacreations</p>
          </div>
      ...
      <section className="py-24 bg-amber-50 relative overflow-hidden">
          ...
          <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="w-full h-full absolute">
            ...
            <defs>
              <pattern id="pattern" width="10" height="10" patternUnits="userSpaceOnUse">
                <circle cx="2" cy="2" r="1" fill="currentColor" className="text-amber-900" />
              </pattern>
            </defs>
          </svg>
        </div>
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
          ...
          <h2 className="text-3xl md:text-5xl font-serif text-stone-900 mb-6">
            Looking for beautiful handmade decor?
          </h2>
          <p className="text-lg text-stone-600 mb-10">
            Chat with us on WhatsApp to place your order, ask questions, or request custom designs for your special occasions.
          </p>
          <a
            href="https://wa.me/919989411965"
            target="_blank"
