    ...
    <div className="min-h-screen flex flex-col font-sans bg-[#fcfaf8] text-stone-900">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-stone-200">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3">
            <div className="h-14 w-14 shrink-0 rounded-full overflow-hidden bg-white border border-amber-200 flex items-center justify-center shadow-sm">
              <img 
                src="/logo.png" 
            ...
            <div className="flex flex-col">
              <span className="font-serif text-2xl font-bold text-amber-900 tracking-tight leading-none">
                Radhe Krishna
              </span>
              <span className="font-serif text-sm text-amber-700 hidden sm:block mt-1">
                Creations & Decor
              </span>
            </div>
          </Link>
      ...
      <footer className="bg-stone-900 text-stone-300 py-16">
        ...
        <div className="container mx-auto px-4 mt-12 pt-8 border-t border-stone-800 text-sm text-stone-500 flex flex-col md:flex-row justify-between items-center">
          ...
          <Link to="/admin" className="mt-4 md:mt-0 hover:text-stone-300">Admin Login</Link>
        </div>
      </footer>
    </div>
  );
